...
{ 
    typedef complex<R> C;
    const size_t d = 1;
    const bfly::Context<R,1,q>& bflyContext = nuftContext.GetButterflyContext();
    ...
    const vector<R>& chebyshevNodes = bflyContext.GetChebyshevNodes();
        ...
        WeightGridList<R,2,q>& weightGridList )
{
    ...
    const bfly::Context<R,2,q>& bflyContext = nuftContext.GetButterflyContext();
